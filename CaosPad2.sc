...
CaosPad2 {
			*ar {|att = 0.5, rel = 1, note = 220, fmax = 1, fm = 0.125, harm = 1, rmix = 0.75, rroom = 0.5, rfilt = 0.1,
			...
			*robot {|att = 0.5, rel = 1, note = 220, fmax = 1, fm = 0.125, harm = 1, rmix = 0.75, rroom = 0.5, rfilt = 0.1, amp1 = 0.5, amp2 = 0.5, t = 0.25, tp = 0 |
					var sig1,sig2,pad,nota,env;
						nota=note.midicps;
						sig1=SinOsc.ar(SinOsc.kr(fm,0,nota,nota+fmax),0,amp1);
						sig2=Blip.ar(Blip.kr(fm,harm/2,nota,nota+fmax),harm,amp2);
