...
CaosHats2 : CaosKick {
	...
	*ar {|att=0.025,rel=0.5,highcutfreq=10000,rq=0.5,gate=1,amp1=1,amp2=1,pan=#[0.94, -0.95]|
		var hats,env;
	...
	*robot {|att=0.025,rel=0.5,highcutfreq=10000,rq=0.5,amp1=1,amp2=1,t=1,tp=0,pan=#[0.94, -0.95]|
		var hats,env;
