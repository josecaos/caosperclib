...
CaosSnare {
	*ar {|att= 0.01, rel= 0.35, highcutfreq= 520, rq= 0.75, gate= 0.5, amp1= 0.4, amp2= 1|
		var sna,env;
...
*robot {|att= 0.01, rel= 0.35, highcutfreq= 520, rq= 0.75, amp1= 0.5, amp2= 0.4, t=1,tp=0|
		var sna,env;
   	     		sna=Limiter.ar(RHPF.ar(PinkNoise.ar(amp1)+
   	     									LFTri.ar(Mix(220,480,1125,2220,4218),0,amp2/2.2)+
   	     										GrayNoise.ar(amp1/1.5),520,0.75),0.7);
        		sna=CompanderD.ar(sna,0.5,0.6,0.7);
